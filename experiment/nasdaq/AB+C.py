...
def optimizer_by_lazy_handle_and_calculate_plan_and_prefix_optimizer(regex, min_window_time, max_window_time, source,
                                                                     rate, output):
    regex_main = "B C"
    regex_prefix = "A{5,}"
    ...
    try:
        while True:
            ...
            if data_item:
                ...
                # 处理事件并更新 NFA 状态
                matches_main = nfa_main.process(accessor, nfa_state_main, event_wrapper, data_item.timestamp,
