...
def test(regex, min_window_time, max_window_time, data_source, rate, lazy_model, lazy_calculate_model):
    ...
    if lazy_model:
        postponing(valid_states, window_times, max_window_time, data_source, rate, lazy_calculate_model, contiguity_strategy_copy)
    else:
        # print("Test nfa handle:")
        nfa(valid_states, window_times, max_window_time, data_source, rate, contiguity_strategy_copy)
