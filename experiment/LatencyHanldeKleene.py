...
def test_frequency_influence_latency():
                ...
                try:
                    ...
                    while True:
                        ...
                        if data_item:
                            ...
                            if matches:
                                for match in matches:
                                    ...
                                    for b_accessor in match['B[i]']:
                                        b_max = max(b_accessor.event.get_value(), b_max)
                                    a_values = []
                                    ...
                                    for r in range(1, len(a_values) + 1):
                                        ...
                                        for combination in itertools.combinations(a_values, r):
                                            ...
                                            if avg >= 25 - b_max:
                                                ...
                                                if 10 <= sum_square_diff <= 20:
                                                    answer.append(sum_square_diff)
                                    print(answer)
                            ...
                            if item_count >= 100 or handle_time > 100 * (fa + fb):  # 假设处理 100 个数据项后停止
                                break
    ...
    plt.title("Handle Time With latency for Different Frequencies")
    plt.legend()
    plt.show()
    ...
    df.to_csv('../output/experiment/csv/latency_handle_influence_matches_time.csv', index=False)
