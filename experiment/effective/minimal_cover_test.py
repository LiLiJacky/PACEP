...
if __name__ == "__main__":
        ...
        for a in np.arange(0.2, 1.0, 0.2):
            ...
            for max_window_time in max_window_times:
                ...
                for event_selection_strategy, contiguity_strategy in contiguity_strategys.items():
                    ...
                    # Lazy 测试
                    lazy_handle_time, lazy_matches = test(regex, min_window_time, max_window_time, data_source, rate,
    ...
    # 保存图片
    output_image_path = "../../output/minimal_test_result_by_frequency_colored.png"
